...
import MentorLoginCard from "./MentorLoginCard";
import MentorRegisterIllustration from "../mentor-register/MentorRegisterIllustration";

const MentorLogin = () => {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#081120]">
