...
import { resetMentorPassword } from "../../services/mentorAuth.service";

import PasswordInput from "../../common/PasswordInput";

const MentorResetPasswordCard = () => {
  // ==========================================================
  // Navigation
  // ==========================================================
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await resetMentorPassword({
        email,
...
export default MentorResetPasswordCard;
